                                ...
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="ejercicio5.php" method="POST">
                                            <input type="number" name="escopeta" value="<?php echo $escopeta->balasRes(); ?>" readonly>
                                            <br><br><br><button type="submit" name="recargarE" class="btn btn-primary">Recargar</button>
                                            <button type="submit" name="dispararE" class="btn btn-primary">Disparar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
